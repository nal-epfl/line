...
QGraphicsTooltip::QGraphicsTooltip(const QString &text, QGraphicsItem *parent) :
	QGraphicsTextItem(text, parent)
{
}

void QGraphicsTooltip::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
